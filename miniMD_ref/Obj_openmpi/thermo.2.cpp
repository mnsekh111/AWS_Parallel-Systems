...
MMD_float Thermo::energy(Atom &atom, Neighbor &neighbor, Force* force)
{
  ...
  if(sizeof(MMD_float) == 4)
    MPI_Allreduce(&e_act, &eng, 1, ((MPI_Datatype)10), (MPI_Op)(102), 91);
  else
    MPI_Allreduce(&e_act, &eng, 1, ((MPI_Datatype)11), (MPI_Op)(102), 91);
...
#pragma omp master
  {
    if(sizeof(MMD_float) == 4)
      MPI_Allreduce(&t_act, &t1, 1, ((MPI_Datatype)10), (MPI_Op)(102), 91);
    else
      MPI_Allreduce(&t_act, &t1, 1, ((MPI_Datatype)11), (MPI_Op)(102), 91);
...
MMD_float Thermo::pressure(MMD_float t, Force* force)
{
  ...
  if(sizeof(MMD_float) == 4)
    MPI_Allreduce(&p_act, &virial, 1, ((MPI_Datatype)10), (MPI_Op)(102), 91);
  else
    MPI_Allreduce(&p_act, &virial, 1, ((MPI_Datatype)11), (MPI_Op)(102), 91);
