...
# 51 "/usr/lib/gcc/x86_64-redhat-linux/4.1.2/../../../../include/c++/4.1.2/cstdio" 2 3
...
# 52 "/usr/lib/gcc/x86_64-redhat-linux/4.1.2/../../../../include/c++/4.1.2/cstdio" 2 3
...
# 33 "setup.cpp" 2
# 1 "/usr/lib/gcc/x86_64-redhat-linux/4.1.2/../../../../include/c++/4.1.2/cmath" 1 3
# 48 "/usr/lib/gcc/x86_64-redhat-linux/4.1.2/../../../../include/c++/4.1.2/cmath" 3
       
# 49 "/usr/lib/gcc/x86_64-redhat-linux/4.1.2/../../../../include/c++/4.1.2/cmath" 3
...
# 52 "/usr/lib/gcc/x86_64-redhat-linux/4.1.2/../../../../include/c++/4.1.2/cmath" 2 3
...
# 54 "/usr/lib/gcc/x86_64-redhat-linux/4.1.2/../../../../include/c++/4.1.2/cmath" 2 3
# 82 "/usr/lib/gcc/x86_64-redhat-linux/4.1.2/../../../../include/c++/4.1.2/cmath" 3
namespace std
{
...
# 515 "/usr/lib/gcc/x86_64-redhat-linux/4.1.2/../../../../include/c++/4.1.2/cmath" 3
namespace std
{
  template<typename _Tp>
    inline int
...
# 1 "/usr/lib/gcc/x86_64-redhat-linux/4.1.2/../../../../include/c++/4.1.2/bits/cmath.tcc" 1 3
# 35 "/usr/lib/gcc/x86_64-redhat-linux/4.1.2/../../../../include/c++/4.1.2/bits/cmath.tcc" 3
namespace std
{
  template<typename _Tp>
    inline _Tp
...
# 576 "/usr/lib/gcc/x86_64-redhat-linux/4.1.2/../../../../include/c++/4.1.2/cmath" 2 3
# 34 "setup.cpp" 2
...
int read_lammps_data(Atom &atom, Comm &comm, Neighbor &neighbor, Integrate &integrate, Thermo &thermo, char* file, int units)
{
  ...
  int natoms;
  MPI_Allreduce(&atom.nlocal, &natoms, 1, ((MPI_Datatype)6), (MPI_Op)(102), 91);
...
# 347 "setup.cpp"
  ...
  int iflagall;
  MPI_Allreduce(&iflag, &iflagall, 1, ((MPI_Datatype)6), (MPI_Op)(100), 91);
...
void create_velocity(double t_request, Atom &atom, Thermo &thermo)
{
  ...
  double tmp;
  MPI_Allreduce(&vxtot, &tmp, 1, ((MPI_Datatype)11), (MPI_Op)(102), 91);
  vxtot = tmp / atom.natoms;
  MPI_Allreduce(&vytot, &tmp, 1, ((MPI_Datatype)11), (MPI_Op)(102), 91);
  vytot = tmp / atom.natoms;
  MPI_Allreduce(&vztot, &tmp, 1, ((MPI_Datatype)11), (MPI_Op)(102), 91);
