...
int Comm::setup(MMD_float cutneigh, Atom &atom)
{
  ...
  MPI_Cart_create(91, 3, procgrid, periods, reorder, &cartesian);
...
#pragma omp master
      {
        if(sizeof(MMD_float) == 4) {
          MPI_Irecv(buf_recv, comm_recv_size[iswap], ((MPI_Datatype)10),
          recvproc[iswap], 0, 91, &request);
          MPI_Send(buf_send, comm_send_size[iswap], ((MPI_Datatype)10),
          sendproc[iswap], 0, 91);
        } else {
          MPI_Irecv(buf_recv, comm_recv_size[iswap], ((MPI_Datatype)11),
          recvproc[iswap], 0, 91, &request);
          MPI_Send(buf_send, comm_send_size[iswap], ((MPI_Datatype)11),
          sendproc[iswap], 0, 91);
        }
...
#pragma omp master
      {
        if(sizeof(MMD_float) == 4) {
          MPI_Irecv(buf_recv, reverse_recv_size[iswap], ((MPI_Datatype)10),
          sendproc[iswap], 0, 91, &request);
          MPI_Send(buf_send, reverse_send_size[iswap], ((MPI_Datatype)10),
          recvproc[iswap], 0, 91);
        } else {
          MPI_Irecv(buf_recv, reverse_recv_size[iswap], ((MPI_Datatype)11),
          sendproc[iswap], 0, 91, &request);
          MPI_Send(buf_send, reverse_send_size[iswap], ((MPI_Datatype)11),
          recvproc[iswap], 0, 91);
        }
        MPI_Wait(&request, &status);
      }
...
#pragma omp master
    {
      ...
      MPI_Send(&nsend, 1, ((MPI_Datatype)6), procneigh[idim][0], 0, 91);
      MPI_Recv(&nrecv1, 1, ((MPI_Datatype)6), procneigh[idim][1], 0, 91, &status);
      nrecv = nrecv1;

      if(procgrid[idim] > 2) {
        MPI_Send(&nsend, 1, ((MPI_Datatype)6), procneigh[idim][1], 0, 91);
        MPI_Recv(&nrecv2, 1, ((MPI_Datatype)6), procneigh[idim][0], 0, 91, &status);
        nrecv += nrecv2;
      }
      ...
      if(sizeof(MMD_float) == 4) {
        MPI_Irecv(buf_recv, nrecv1, ((MPI_Datatype)10), procneigh[idim][1], 0,
                  91, &request);
        MPI_Send(buf_send, nsend, ((MPI_Datatype)10), procneigh[idim][0], 0, 91);
      } else {
        MPI_Irecv(buf_recv, nrecv1, ((MPI_Datatype)11), procneigh[idim][1], 0,
                  91, &request);
        MPI_Send(buf_send, nsend, ((MPI_Datatype)11), procneigh[idim][0], 0, 91);
      }
      ...
      if(procgrid[idim] > 2) {
        if(sizeof(MMD_float) == 4) {
          MPI_Irecv(&buf_recv[nrecv1], nrecv2, ((MPI_Datatype)10), procneigh[idim][0], 0,
                    91, &request);
          MPI_Send(buf_send, nsend, ((MPI_Datatype)10), procneigh[idim][1], 0, 91);
        } else {
          MPI_Irecv(&buf_recv[nrecv1], nrecv2, ((MPI_Datatype)11), procneigh[idim][0], 0,
                    91, &request);
          MPI_Send(buf_send, nsend, ((MPI_Datatype)11), procneigh[idim][1], 0, 91);
        }
  ...
  for(idim = 0; idim < 3; idim++) {
    ...
    for(int ineed = 0; ineed < 2 * need[idim]; ineed += 1) {
      if(ineed < procgrid[idim] - 1) {
        MPI_Send(&nsend, 1, ((MPI_Datatype)6), sendproc_exc[iswap], 0, 91);
        MPI_Recv(&nrecv, 1, ((MPI_Datatype)6), recvproc_exc[iswap], 0, 91, &status);

        if(nrecv > maxrecv) growrecv(nrecv);

        if(sizeof(MMD_float) == 4) {
          MPI_Irecv(buf_recv, nrecv, ((MPI_Datatype)10), recvproc_exc[iswap], 0,
                    91, &request);
          MPI_Send(buf_send, nsend, ((MPI_Datatype)10), sendproc_exc[iswap], 0, 91);
        } else {
          MPI_Irecv(buf_recv, nrecv, ((MPI_Datatype)11), recvproc_exc[iswap], 0,
                    91, &request);
          MPI_Send(buf_send, nsend, ((MPI_Datatype)11), sendproc_exc[iswap], 0, 91);
        }
...
#pragma omp master
      {
        ...
        if(sendproc[iswap] != me) {
          MPI_Send(&nsend, 1, ((MPI_Datatype)6), sendproc[iswap], 0, 91);
          MPI_Recv(&nrecv, 1, ((MPI_Datatype)6), recvproc[iswap], 0, 91, &status);

          if(nrecv * atom.border_size > maxrecv) growrecv(nrecv * atom.border_size);

          if(sizeof(MMD_float) == 4) {
            MPI_Irecv(buf_recv, nrecv * atom.border_size, ((MPI_Datatype)10),
                      recvproc[iswap], 0, 91, &request);
            MPI_Send(buf_send, nsend * atom.border_size, ((MPI_Datatype)10),
                     sendproc[iswap], 0, 91);
          } else {
            MPI_Irecv(buf_recv, nrecv * atom.border_size, ((MPI_Datatype)11),
                      recvproc[iswap], 0, 91, &request);
            MPI_Send(buf_send, nsend * atom.border_size, ((MPI_Datatype)11),
                     sendproc[iswap], 0, 91);
          }
