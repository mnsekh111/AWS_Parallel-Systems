            ...
            Thermo &thermo, Integrate &integrate, Timer &timer, int screen_yaml)
{
  ...
  int nlostall;
  MPI_Allreduce(&nlost, &nlostall, 1, ((MPI_Datatype)6), (MPI_Op)(102), 91);
  ...
  if(me == 0) {
    ...
    if(screen_yaml) {
      ...
      fprintf(stdout, "  variant: " "miniMD-Reference 1.2 (MPI+OpenMP)" "\n");
    ...
    fprintf(fp, "  variant: " "miniMD-Reference 1.2 (MPI+OpenMP)" "\n");
  ...
  MPI_Allreduce(&time_total, &tmp, 1, ((MPI_Datatype)11), (MPI_Op)(102), 91);
  ...
  MPI_Allreduce(&time_force, &tmp, 1, ((MPI_Datatype)11), (MPI_Op)(102), 91);
  tmp /= nprocs;
  ...
  MPI_Allreduce(&time_neigh, &tmp, 1, ((MPI_Datatype)11), (MPI_Op)(102), 91);
  tmp /= nprocs;
  ...
  MPI_Allreduce(&time_comm, &tmp, 1, ((MPI_Datatype)11), (MPI_Op)(102), 91);
  tmp /= nprocs;
  ...
  MPI_Allreduce(&time_other, &tmp, 1, ((MPI_Datatype)11), (MPI_Op)(102), 91);
  tmp /= nprocs;
  ...
  MPI_Allreduce(&tmp, &total, 1, ((MPI_Datatype)11), (MPI_Op)(102), 91);
           ...
           int nhisto, int* histo)
{
  ...
  int ntotal;
  MPI_Allreduce(&n, &ntotal, 1, ((MPI_Datatype)6), (MPI_Op)(102), 91);
  double tmp;
  MPI_Allreduce(&ave, &tmp, 1, ((MPI_Datatype)11), (MPI_Op)(102), 91);
  ave = tmp / ntotal;
  MPI_Allreduce(&min, &tmp, 1, ((MPI_Datatype)11), (MPI_Op)(101), 91);
  min = tmp;
  MPI_Allreduce(&max, &tmp, 1, ((MPI_Datatype)11), (MPI_Op)(100), 91);
  max = tmp;
  ...
  MPI_Allreduce(histo, histotmp, nhisto, ((MPI_Datatype)6), (MPI_Op)(102), 91);
